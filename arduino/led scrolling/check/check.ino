...
int array_turn=0;
byte your_text[][6]={BJ,BU,BT,BE,SPACE,BK,BH,BA,BT,BT,BE,SPACE,BE,BN,BG,BI,BN,BE,BE,BR,BI,BN,BG,SPACE,BC,BO,BN,BS,BU,BL,BT,BA,BN,BC,BE,SPACE,SPACE,SPACE,BB,BA,BN,BG,BA,BN,BG,BA,LINE,NUM0,NUM7,SPACE,BK,BO,BI,BL,BI,SPACE,BB,BA,BN,BG,BA,BI,BN,SPACE,SPACE,SPACE,BC,BO,BN,BT,BA,BC,BT,SPACE,BE,BR,DOT,BN,BA,BW,BA,BR,BA,BJ,SPACE,BP,BA,BN,BD,BE,BY,SPACE,SPACE,NUM9,NUM8,NUM5,NUM1,NUM1,NUM7,NUM7,NUM5,NUM8,NUM0,SPACE};//PUT YOU TEXT HERE
...
byte make_word (long posistion,byte turn){
  ...
  void loop() {
        ...
        display_word(1,your_text,104,25);// calls for the display_pattern function and says that int loop = 15(if you do more loop the pattern whould scrole slower).
