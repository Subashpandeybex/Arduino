...
int array_turn=0;
byte your_text[][6]={BH,BI,SPACE,BM,BY,SPACE,BN,BA,BM,BE,SPACE,BI,SPACE,BS,BU,BB,BA,BS,BH,SPACE,BP,BA,BN,BD,BE,BY};//PUT YOU TEXT HERE
...
byte make_word (long posistion,byte turn){
  ...
  void loop() {
        ...
        display_word(1,your_text,103,30);// calls for the display_pattern function and says that int loop = 15(if you do more loop the pattern whould scrole slower).
